...
class MakeupDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        if self.opt.phase == 'test_pair':
            ...
            non_makeup_parse = self.load_parse(self.non_makeup_path[non_makeup_index].replace('reference_imgs', 'segment_imgs'), non_makeup_angle)

            makeup_img = self.load_img(self.makeup_path[makeup_index],makeup_angle)
            makeup_parse = self.load_parse(self.makeup_path[makeup_index].replace('reference_imgs', 'segment_imgs'), makeup_angle)
