...
class MakeupOptions():
    def __init__(self):
        ...
        # data loader related
        self.parser.add_argument('--dataroot', type=str, default='./res/reference_imgs', help='path of data')
        ...
        self.parser.add_argument('--result_dir', type=str, default='./result_imgs',
                                 help='path for saving result images and models')
        self.parser.add_argument('--checkpoint_dir', type=str, default='./models',
